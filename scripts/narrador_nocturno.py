...
def user_prompt_cron(
    *, logs: str, maleta: str, biblia: str, diario: str, estado: dict[str, str],
    ...
    return (
        ...
        "NUNCA repitas ni parafrasees episodios anteriores de la maleta. "
        "Escribe algo completamente nuevo basado en los LOGS DEL DÍA de hoy.\n\n"
        "PARTE 2 — ACTUALIZA TUS ARCHIVOS\n"
        "MALETA_UPDATE (solo si hubo algo que valió guardar; puede estar vacío)\n"
        "DIARIO_UPDATE (JSON con los mismos campos del diario; DEBES incrementar dia_vida y dia_mundo, y poner la ubicación real según los logs)\n"
